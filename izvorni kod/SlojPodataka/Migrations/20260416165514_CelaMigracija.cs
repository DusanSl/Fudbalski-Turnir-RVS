        ...
        protected override void Up(MigrationBuilder migrationBuilder)
{
    ...
    migrationBuilder.Sql(@"
        CREATE PROCEDURE sp_DajUkupanBrojZapisnika
        AS
        BEGIN
            SELECT COUNT(*) FROM Zapisnik
        END
    ");
}
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS sp_DajUkupanBrojZapisnika");

            migrationBuilder.DropTable(name: "Korisnik");
            migrationBuilder.DropTable(name: "StavkaZapisnika");
            migrationBuilder.DropTable(name: "Zapisnik");
            migrationBuilder.DropTable(name: "Klub");
        }
    }
}
